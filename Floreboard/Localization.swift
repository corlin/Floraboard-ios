...
struct Locales {
  static let en: [String: String] = [
    ...
    // Errors
    "error.missingApiKey": "AI service is not ready. Please contact support.",
    "error.invalidURL": "Invalid API Endpoint URL.",
    "error.apiError": "API Request failed with status code: {{code}}",
    "error.api.invalidResponse": "The AI service returned an invalid response.",
    ...
    "settings.aiServiceMode": "Service Mode",
    "settings.aiServiceManaged": "Managed",
    "settings.aiServiceManagedDesc": "Floreboard manages AI access for this store. Users do not need to configure LLM API keys.",
  ...
  static let zh: [String: String] = [
    ...
    // Errors
    "error.missingApiKey": "AI 服务尚未就绪，请联系支持人员。",
    "error.invalidURL": "API 接口地址无效。",
    "error.apiError": "API 请求失败，状态码: {{code}}",
    "error.api.invalidResponse": "AI 服务返回了无效响应。",
    ...
    "settings.aiServiceMode": "服务模式",
    "settings.aiServiceManaged": "平台托管",
    "settings.aiServiceManagedDesc": "Floreboard 为当前店铺托管 AI 访问能力，用户无需配置 LLM API Key。",
